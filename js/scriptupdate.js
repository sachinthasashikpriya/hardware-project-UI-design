...
function start() {
    // Debugging statement to check the value of startValue
    console.log('startValue:', startValue);
    
    if (!startValue) {
        console.error('startValue is not defined or is null');
        return;
    }
    ...
    return startValue.writeValueWithResponse(arr).then(response => {
        ...
        // Check if exerciseValue is defined and has startNotifications method
        if (!exerciseValue || !exerciseValue.startNotifications) {
            console.error('exerciseValue is not defined or does not have startNotifications method');
            return;
        }
